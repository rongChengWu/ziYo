    ...
    <table width="100%" cellspacing="0" cellpadding="2" bordercolor="#9fd9e8" border="1" bgcolor="#d0e6f1" bordercolordark="#EDF2FA">
        <tbody>
            <tr class="formtitletr">
                <td colspan="4" bgcolor="#81BDDA"><b>入库单基本信息：</b></td>
            </tr>
            <tr class="formtitletr">
                <td class="formtitle">
                   入库单编号(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" id="year" name="rkd.rkdbh"/>
                </td>
                <td class="formtitle">
                    制单人(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1" id="month" value="${userLogin.userName}"  name="zdr" readonly="readonly"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle">
                ...
                <td class="formcontent">
                    <input  name="rkd.zdrq" readonly="readonly" class="Wdate editbox input1" type="text"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td>
                <td class="formtitle">
                    本单金额(<font color="red">必填</font>)：
                </td>
                  <td class="formcontent">
                    <input  readonly="readonly"   class="input1" type="text" name="rkd.bdje" />
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle">
                ...
                <td class="formcontent" colspan="3">
                    <textarea  cols="40" rows="8" id="tpaService" name="rkd.bz"></textarea>
                </td>
            </tr>
                <tr class="formtitle">
                <td colspan="3" bgcolor="#81BDDA"><b>入库单详情:</b> </td>
