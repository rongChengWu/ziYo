        ...
        <tbody>
            ...
            <tr class="formtitletr">
                ...
                <td class="formcontent">
                    <input type="text" class="input1"  name="product.cpbm"/>
                </td>
                <td class="formtitle">
                    产品名称(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                    <input type="text" class="input1"   name="product.cpmc"/>
                </td>
            </tr>
            <tr class="formtitle">
                <td class="formtitle">
                ...
                <td class="formcontent">
                    <input type="text" class="input1" value="" name="product.cpgg"/>
                </td>
                <td class="formtitle">
                ...
                <td class="formcontent">
                    ...
                    <option value="1" selected="selected">国产</option>
             ...
             <tr class="formtitle">
                ...
                <td class="formcontent">
                    <select class="js-example-data-array" name="product.tsid"></select>
                </td>
                <td class="formtitle">
                 单位(<font color="red">必填</font>)：
                </td>
                <td class="formcontent">
                  <input type="text" class="input1" value="" name="product.dw"/>
                </td>
                </td>
            </tr>
            <tr class="formtitle">
